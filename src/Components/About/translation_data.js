const data = {
  English: {
    ...
    Contact: {
      ...
      title: "Contact",
      p1: "Have any suggestions? Want any other games to be added? Send a message! You will receive an answer as soon as possible.",
  ...
  Spanish: {
    ...
    Contact: {
      alertMsg:
        "Tu mensaje ha sido enviado. Recibirás una respuesta lo antes posible.  ",
      title: "Contacto",
      p1: "¿Tienes alguna sugerencia? ¿Quieres que se añada algún otro juego? ¡Envía un mensaje! Recibirás una respuesta lo antes posible.",
      emailPlaceholder: "Introduce tu email",
      msgTxt: "Mensaje",
      msgPlaceholder: "Introduce aquí el mensaje.",
